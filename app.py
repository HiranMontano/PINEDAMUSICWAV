...
# YouTube video IDs → pre-compute thumbnails and real hrefs
VIDEOS = [
    {
        "id": "YCxhXTU4NrE",
        "url": "https://www.youtube.com/watch?v=YCxhXTU4NrE&list=RDYCxhXTU4NrE&start_radio=1",
    ...
    {
        "id": "r7QvKXb2bo4",
        "url": "https://youtube.com/shorts/r7QvKXb2bo4?si=tNswV1ALOctfn68Q",
        "title": "Arreglos",
        "label": "YouTube",
        "main": False,
    },
...
/* ── Reveal: always visible (no IntersectionObserver in Streamlit) ── */
.reveal {
    opacity: 1 !important;
...
.image-card:hover .portfolio-img {
...
.video-card:hover .video-thumb {
    transform: scale(1.06);
    filter: contrast(1.15) saturate(1.05) brightness(0.82);
}
...
<div class="page">
  ...
  <div id="bio" class="section">
    <div class="bio-copy reveal">
      ...
      <p class="bio-text">
        ...
        y otros lenguajes modernos para crear sonoridades vivas, profundas y diferentes. Busco que
        cada proyecto tenga carácter propio, que conecte emocionalmente y que haga sentir al artista
    ...
    <div class="bio-card reveal">
      <img
        ...
        alt="Foto principal de Juan David Pineda"
        class="bio-main-img"
      />
  ...
  <div id="imagenes" class="section">
    ...
    <div class="image-grid reveal">
      <div class="image-card" data-label="Live">
        <img src="https://i.pinimg.com/736x/36/25/d9/3625d966695bb11b73a264aa40bb730e.jpg"
             alt="Press shot de Juan David Pineda" class="portfolio-img" />
      </div>
      <div class="image-card" data-label="Studio">
        <img src="https://i.pinimg.com/736x/c1/16/3d/c1163d9709a92765a73b77d228c256d2.jpg"
             alt="Juan David Pineda produciendo en estudio" class="portfolio-img" />
      </div>
      <div class="image-card" data-label="Live">
        <img src="https://i.pinimg.com/736x/3d/4e/12/3d4e1260525308ad698817b782a7a468.jpg"
             alt="Juan David Pineda tocando en vivo" class="portfolio-img" />
      </div>
      <div class="image-card" data-label="Direccion">
        <img src="https://i.pinimg.com/736x/ff/c8/2c/ffc82c53f240cb29ccddbbe8fc03dc8b.jpg"
             alt="Moodboard musical de referencias" class="portfolio-img" />
      </div>
      <div class="image-card" data-label="Arreglos">
        <img src="https://i.pinimg.com/736x/42/ef/8d/42ef8dbbc4625969554a3f613b886ac9.jpg"
             alt="Backstage y proceso creativo" class="portfolio-img" />
      </div>
    </div>
  </div>
  ...
  <div id="videos" class="section">
    ...
    <div class="video-layout reveal">
      ...
      <a class="video-card video-main"
        ...
        <img src="{yt_thumb(VIDEOS[0]['id'])}"
             alt="{VIDEOS[0]['title']}" class="video-thumb" />
        <div class="play">▶</div>
      ...
      <div class="video-stack">
        <a class="video-card"
           href="{VIDEOS[1]['url']}"
           target="_blank" rel="noopener">
          <img src="{yt_thumb(VIDEOS[1]['id'])}"
               alt="{VIDEOS[1]['title']}" class="video-thumb" />
          <div class="play">▶</div>
          <div class="video-caption">
            <h3>{VIDEOS[1]['title']}</h3>
            <span>{VIDEOS[1]['label']}</span>
          </div>
        </a>
        ...
        <a class="video-card"
           href="{VIDEOS[2]['url']}"
           target="_blank" rel="noopener">
          <img src="{yt_thumb(VIDEOS[2]['id'])}"
               alt="{VIDEOS[2]['title']}" class="video-thumb" />
          <div class="play">▶</div>
          <div class="video-caption">
            <h3>{VIDEOS[2]['title']}</h3>
            <span>{VIDEOS[2]['label']}</span>
          </div>
        </a>
      </div>
    ...
    <div class="project-grid">
      <div class="project-cover reveal">
        <img
          ...
          alt="Imagen del proyecto personal"
      ...
      <div class="project-copy reveal">
        <p class="manifesto">
          ...
          el sampling, el bajo eléctrico y la sensibilidad armónica del jazz. Es un espacio para
          contar historias desde el groove: beats con textura, melodías oscuras, baterías con peso
          y una estética cruda, directa y emocional.
        </p>
        <p class="manifesto">
          Más que producir por producir, busco construir una identidad completa: portada, sonido,
          narrativa, referencias, arreglos e intención. Cada canción tiene que sentirse como una
          escena, una calle, una noche o una memoria.
        </p>
        ...
        <div class="services">
          <a class="service"
             ...
             target="_blank" rel="noopener">
            <h4>Spotify</h4>
            <p>Escucha mis lanzamientos oficiales, colaboraciones y producciones disponibles
          ...
          <a class="service"
             ...
             target="_blank" rel="noopener">
            <h4>YouTube</h4>
            <p>Mira live sessions, presentaciones, contenido visual y procesos detrás de
               cada proyecto.</p>
          </a>
          <a class="service"
             ...
             target="_blank" rel="noopener">
            <h4>SoundCloud</h4>
            <p>Encuentra demos, beats, ideas en proceso y material experimental que complementa
               mi universo sonoro.</p>
          </a>
          <a class="service"
             href="https://www.instagram.com/pinedamusic.wav/?hl=es"
             target="_blank" rel="noopener">
            <h4>Instagram</h4>
            <p>Sigue mi proceso creativo, contenido visual, reels, sesiones y momentos del
               día a día como músico y productor.</p>
          </a>
        </div>
      </div>
    </div>
